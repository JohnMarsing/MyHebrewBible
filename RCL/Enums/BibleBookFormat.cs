...
public static class BibleBookFormat
{
	...
	//MyHebrewBible.Client.Features.BookChapter.Toolbar.NumberPad.BookChapterVerse?
	public static string BCV(BookChapterVerseRecord? bcv, bool useAbrv = true)  // Genesis 1 or Gen 1
	{
