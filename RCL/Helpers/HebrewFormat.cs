...
public class HebrewFormat
{
	...
	{
		hebrew1 ??= string.Empty;
		hebrew2 ??= string.Empty;
		hebrew3 ??= string.Empty;
		...
		return wordEnum switch
		{
			...
			_ => $"<span class='at-red'>{hebrew1}</span> <span class='last-seg-type-paseq'>׀</span>"
		};
	}

	private const string Maqqef = "־";
