...
public class State
{
	...
	private readonly AbrvChapterVerse _DefaultAbrvChapterVerse = AbrvChapterVerse.Default;
	private AbrvChapterVerse? _AbrvChapterVerse = AbrvChapterVerse.Default;  
	...
	private readonly List<BookChapterVerseHistory>? _DefaultBCVs =
			[
				new BookChapterVerseHistory(RCL.Enums.BibleBook.Deuteronomy.Value, 6, 4),
				new BookChapterVerseHistory(RCL.Enums.BibleBook.Leviticus.Value, 26, 40),
				new BookChapterVerseHistory(RCL.Enums.BibleBook.Matthew.Value, 5, 17)
			];
	...
	{
		var (errMsg, _bibleBookId) = RCL.Enums.BibleBookDictionary.GetId(_AbrvChapterVerse!.Abrv);
