...
namespace PWA.Features.Parasha.Enums;
...
public abstract class ShowSection : SmartEnum<ShowSection>
{
	...
	private sealed class TorahSE : ShowSection
	{
		...
		public override string ButtonColorTOC => "btn-link";
		public override string ButtonColorShowHide => "btn-success";
		public override string HeaderColor => "text-success";
		public override string LineItemButtonColor => "btn-outline-success";
	}
	...
	private sealed class HaftorahSE : ShowSection
	{
		...
		public override string ButtonColorTOC => "btn-link";
		public override string ButtonColorShowHide => "btn-warning";
		public override string HeaderColor => "text-warning";
		public override string LineItemButtonColor => "btn-outline-warning";
	}
	...
	private sealed class BritSE : ShowSection
	{
		...
		public override string ButtonColorTOC => "btn-link";
		public override string ButtonColorShowHide => "btn-danger";
		public override string HeaderColor => "text-danger";
		public override string LineItemButtonColor => "btn-outline-danger";
	}
	#endregion
}
// Ignore Spelling: Toc