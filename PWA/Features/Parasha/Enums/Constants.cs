...
/*
Use RCL.Features.Parasha.Constants.ParashaFacts
...
{	
	...
	{
		return $"parasha/{triennial.Value}/{RCL.Enums.BibleBook.FromValue(triennial.TorahVerse.BibleBook).Abrv}_{triennial.TorahVerse.ChapterVerse.Replace("-", "-to-").Replace(":", "-")}";
	}
